...
public class HobbyResource {
    ...
    @Path("/{name}")
    @Produces({MediaType.APPLICATION_JSON})
    public Response getCityInfoByZipCode(@PathParam("name") String name) {
    ...
    @Produces({MediaType.APPLICATION_JSON})
    public Response getCityInfoByCity(@PathParam("type") String type) {
    ...
    public Response putHobby(@PathParam("name") String name, String hobby){
        ...
        hobbyDTO.setName(name); // Set the original name as the name of the DTO
